...
def training_step(
    ...
    """
    Evaluates the function passed as argument on a batch and updates gradients

    :param loss_func: function that takes as arguments [params, hidden_state, random_key, data, target]
    ...
    (loss, (accuracy, batch_updates)), grads = jax.value_and_grad(loss_fn, has_aux=True)(train_state.params)
